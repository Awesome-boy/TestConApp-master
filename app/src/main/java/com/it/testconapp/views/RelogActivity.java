...
import com.it.testconapp.javabean.ComplexItemEntity;
import com.it.testconapp.javabean.ComplexViewMF;
import com.it.testconapp.utils.WeakHandler;
...
public class RelogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marqueeView1 = (SimpleMarqueeView<String>) findViewById(R.id.marqueeView1);
        marqueeView2 = (SimpleMarqueeView<String>) findViewById(R.id.marqueeView2);
        marqueeView3 = (SimpleMarqueeView<Spanned>) findViewById(R.id.marqueeView3);
        yellowSpeaker = (ImageView) findViewById(R.id.yellowSpeaker);
        marqueeView4 = (MarqueeView<RelativeLayout, ComplexItemEntity>) findViewById(R.id.marqueeView4);
        marqueeView5 = (SimpleMarqueeView<String>) findViewById(R.id.marqueeView5);
        marqueeView6 = (SimpleMarqueeView<String>) findViewById(R.id.marqueeView6);
        DrawableCompat.setTint(DrawableCompat.wrap(yellowSpeaker.getDrawable().mutate()), getResources().getColor(R.color.color_result));
    ...
    private void initMarqueeView2() {
        SimpleMF<String> marqueeFactory2 = new SimpleMF(RelogActivity.this);
    ...
    private void initMarqueeView3() {
        SimpleMF<Spanned> marqueeFactory3 = new SimpleMF<>(RelogActivity.this);
        ...
        marqueeView3.setOnItemClickListener(new OnItemClickListener<TextView, Spanned>() {
            ...
            public void onItemClickListener(TextView mView, Spanned mData, int mPosition) {
                Toast.makeText(RelogActivity.this, String.format("mPosition:%s,mData:%s,mView:%s,.", mPosition, mData, mView), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initMarqueeView4() {
        ...
        MarqueeFactory<RelativeLayout, ComplexItemEntity> marqueeFactory = new ComplexViewMF(RelogActivity.this);
