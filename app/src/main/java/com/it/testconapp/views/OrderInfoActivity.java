...
import com.it.testconapp.adpter.OrderAdapter;
import com.it.testconapp.javabean.AllOrderBean;
import com.it.testconapp.javabean.GoodsOrderInfo;
import com.it.testconapp.javabean.OrderDataHelper;
import com.it.testconapp.javabean.OrderGoodsItem;
import com.it.testconapp.javabean.OrderSummary;
import com.it.testconapp.utils.ToastUtils;
...
public class OrderInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAllOrderAdapter.setOnItemClickListener(new OrderAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ToastUtils.show(view.getContext(),"current postion is:"+position);
            }
        });
